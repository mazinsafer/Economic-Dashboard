...
For code to work, user must obtain their own API key. To view pbix file, user must have Microsoft PowerBI installed. URL to launch dashboard: ecodash.streamlit.app.
[Launch dashboard here.](https://ecodash.streamlit.app)
